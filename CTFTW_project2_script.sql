...
INSERT INTO `Product` (ProductId, Title, Owner, Category, Description, Image, Price, Status) VALUES (
'0343ae28-97fe-49bb-8f69-0499c9c256d3', 'Barbie house', 'lois.hull@gmail.com', 'toys', 
'Im selling my kids barbie house since they have grown out of it and dont 
like barbies anymore. It has been used for many years, but is still in good condition. 
I hope this house can find some new ownersso it can continue to bring joy to others 
as it has given my little girls. Price can be discussed.',
null, 20, 'available');
...
'The prom dress did not fit me so Im selling it. I have only tried it on so it is brand new.
I bought it from zalando and is selling it for half the price. Good deal!',
null, 75, 'available');

INSERT INTO `Product` (ProductId, Title, Owner, Category, Description, Image, Price, Status) VALUES (
'88d145c3-42a8-4dca-84a4-675bb9dcaf42', 'Race car', 'phil.ruiz@gmail.com', 'cars', 
'Selling a broken race car. Buy your fixer-upper dream or sell it for parts!
Only sky is the limit with this race car. Selling it really cheap. Best deal you
will get. Send me a mail for dsicussion of pick up.',
null, 100, 'available');

INSERT INTO `Product` (ProductId, Title, Owner, Category, Description, Image, Price, Status) VALUES (
'4e80d939-ff1a-46d1-9998-43b7cf69b6ac', 'New tent', 'fergus-bishop@outlook.com', 'sport', 
'Pacific Pass Tienda de campaña resistente al agua portátil con sobretecho. Original price
was 39 from amazon.', 
null, 20, 'available');
